...
import com.stackroute.services.TrackServiceImpl;
...
public class TrackControllerTest {
    ...
    public void setUp(){
        ...
        track.setTrackName("spring");
        track.setComments("application");
        list = new ArrayList();
        list.add(track);
    }
    ...
    @Test
    public void getAllTrack() throws TrackNotFoundException,Exception {
        when(trackService.getAllTrack()).thenReturn(list);
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/getAllTrack")
                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(track)))
